...
public final class Constants {
    ...
    /**
     * Nombre maximum de messages affichés  sur la partie information de l'interface
     */

    public static final int MAX_DISPLAYED_MESSAGES = 5;

    /**
     * Nombre minimum de cartes additionnelles (dans le cas d'un tunnel) que le joueur doit choisir
     */
    public static final int MIN_CHOSEN_ADDITIONAL_CARDS = 0;

    /**
     * Nombre minimum de cartes initiales que le joueur doit choisir
     */
    public static final int MIN_CHOSEN_INITIAL_CARDS = 1;
}
